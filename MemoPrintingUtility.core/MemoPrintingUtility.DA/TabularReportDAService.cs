    ...
    public class TabularReportDAService : ITabularReportDAService
    {
        ...
        public List<StudentInformation> GetStudentDetailVR(string Course)
        {
            try
            {
                ...
                var result = StudentContext.SP_GetPresDataforTRVert(Course).AsQueryable();
                var studentdetails = (from stu in result
                                      select new StudentInformation
                                      {
                                          collegecode = stu.FK_CLGCODE,
        ...
        public List<ConsDataEntity> GetStudentsConsDetailsVR(string Course)
        {
            ...
            var studentConsdetails = (from stu in StudentContext.get_ConsDataforTRVert(Course).AsQueryable()
                                      select new ConsDataEntity
                                      {
                                          CODE = stu.CODE,
